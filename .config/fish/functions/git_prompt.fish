function git_prompt --description 'Overloaded prompt function for Git'
  ...
  if test -n "$p"
    if test -n "$s"
      set p "$___fish_git_prompt_color_stashstate$p$___fish_git_prompt_color_stashstate_done"
    else
  ...
  printf "%s$format%s" "$___fish_git_prompt_color_prefix" "$___fish_git_prompt_color_prefix_done$c$b$p$f$r$informative_status$___fish_git_prompt_color_suffix" "$___git_ps_color_suffix_done"
end
